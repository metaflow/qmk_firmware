...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = KEYMAP( \
        ...
        MO(2),   KC_A,    KC_S,   KC_D,   KC_F,   KC_G,   KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT, KC_NUHS, KC_ENT,           KC_HOME,\
    ...
    [1] = KEYMAP( \
        ...
        ____,    ____,    ____,   ____,   ____,   ____,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_RIGHT, ____,    ____,    ____,             ____,\
    ...
    [2] = KEYMAP( \
        ...
        ____,    KC_2,    ____,   ____,   ____,   ____,   ____,    KC_P7,   KC_P8,   KC_P9,    KC_PPLS,  ____,    ____,    ____,             ____,\
        ____,    ____,    ____,   ____,   ____,   ____,   ____,    KC_P4,   KC_P5,   KC_P6,    KC_PENT,  ____,    ____,    ____,             ____,\
        ____,    ____,    ____,   ____,   ____,   ____,   ____,    KC_P1,   KC_P2,   KC_P3,    ____,     ____,    ____,             ____,    ____,\
