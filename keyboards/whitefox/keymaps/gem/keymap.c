...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_NAVI] = LAYOUT( \
        ...
        ____,    KC_F13,  W_FF,    KC_F14, KC_F15, KC_F16, KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC_PSCR,  ____,    ____,    ____,             KC_VOLU, \
        ____,    ____,    KC_SLCK, DEL_LN, ____,   ____,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_RIGHT, ____,    ____,    ____,             KC_VOLD, \
