...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = KEYMAP( \
        TD(TD_ESC),  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,   KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,  KC_INS, \
    ...
    [1] = KEYMAP( \
        ____,    KC_F1,   KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,  KC_F12,  ____,    ____,    KC_PAUSE,\
        ____,    KC_1,    ____,    ____,   ____,   ____,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC_PSCR,  ____,    ____,    ____,             ____,\
        ____,    ____,    KC_SLCK, ____,   ____,   ____,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_RIGHT, ____,    ____,    ____,             ____,\
